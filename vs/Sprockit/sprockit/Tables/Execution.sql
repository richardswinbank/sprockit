CREATE TABLE [sprockit].[Execution] (
    ...
    [ExecutionParameters] XML CONSTRAINT [DF__sprockit_Execution__ExecutionParameters] DEFAULT ('<Parameters/>') NOT NULL,
    ...
    [InitialWatermark]        NVARCHAR(255)                        NULL,
    UpdatedWatermark        NVARCHAR(255)                        NULL,
