CREATE PROCEDURE [sprockit_ReserveProcess].[test GIVEN multiple ready processes THEN highest priority returned]
AS
...
, [Status]
  ...
  (31, @processGroup, 30, 'SomeType', '/My/Process/Path', 'Ready')
, (32, @processGroup, 10, 'SomeType', '/My/Other/Process/Path', 'Ready')
